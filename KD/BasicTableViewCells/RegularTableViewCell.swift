...
protocol RegularTableViewCellDelegate: AnyObject {
    func onSelectButtonTapped(dataModel: BasicModel, index: Int)
    func onUpdateFavoriteButtonTapped(dataModel: BasicModel, index: Int)
    func onAvatarImageViewTapped(dataModel: BasicModel, index: Int)
}

class RegularTableViewCell: UITableViewCell {
    
    weak var delegate: RegularTableViewCellDelegate?
...
//            print("Called after setting the new value")
            ...
            contentTextView.text = dataModel.body
...
//            print("Called before setting the new value")
    ...
    public func setupData(data: BasicModel, index: Int) {
        self.dataModel =  data
        self.index = index
    }
